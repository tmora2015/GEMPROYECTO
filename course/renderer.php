...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $existingcontent = $DB->get_record_sql("SELECT *
		    ...
		    ON cm.instance = w.id
		    WHERE (w.course = '$COURSE->id') and (cm.id = '$mod->id') and (w.content LIKE '<p><a%')");  
		    
	    $countvotes =  $DB->get_record_sql("SELECT count(w.rate) as 'count'
		    FROM {wcd_rate} w 
		    WHERE (w.courseid = '$COURSE->id') and (w.pageid = '$mod->id') ");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($mod->modfullname == 'Page'){ ////////////////////////////////////////////////////////////////////////////////////
        
        if($existingcontent == true) {
            
            $output .= html_writer::link($url, $activitylink, array('class' => $linkclasses, 'onclick' => $onclick)) .'&nbsp'."Votes:".'&nbsp'.$numberofvotes.".".'&nbsp'."Average".'&nbsp'."($meanofvotes)".
                    $groupinglabel;
                    }
            else {
